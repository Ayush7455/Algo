        ...
        <Modal isOpen={categoryEditVisible} onClose={() => setCategoryEditVisible(false)} initialFocusRef={initialRef} finalFocusRef={finalRef}>
          <Modal.Content>
            ...
            <View style={styles.editCategoryModalContainer}>
                <Text style={{paddingHorizontal:10}}>Personal</Text>
            </View>

            <View style={styles.chooseColorContainer}>
                <Text style={styles.chooseColorText}>Category Color</Text>
                <TouchableOpacity style={[styles.colorView,{backgroundColor:"#9F44D3"}]} onPress={()=>setChooseColor(true)}/>
            </View>
            <Text style={{marginTop:10}}>This color will be displayed in interface</Text>
            {chooseColor?
            <View style={styles.categoryColorsView}>
            
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#0396FF"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#D3449A"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#3CC531"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#E96D71"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#0396FF"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#D3449A"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#E96D71"}]} onPress={()=>setChooseColor(false)}/>
            <TouchableOpacity style={[styles.colorView,{backgroundColor:"#3CC531"}]} onPress={()=>setChooseColor(false)}/>
